      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-background/60 mt-1">Device & Computer Solution Platform</p>
              </div>
            </div>
            <p className="text-sm text-background/70 mt-2 text-center md:text-left max-w-xs">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="font-semibold mb-4">Technologiya Services</h4>
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            <h4 className="font-semibold">Contact Technologiya</h4>
            <a 
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          <p className="text-sm text-background/60">Stay updated with Technologiya</p>
          <a
            href="https://whatsapp.com/channel/0029Vb79ecnC6Zvgs8lGhn0v"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-2.5 rounded-full font-medium hover:bg-[#20BD5A] transition-colors"
          >
