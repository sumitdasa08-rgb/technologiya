...
const FAQSection = () => {
  return <section id="faq" className="py-16 md:py-24 bg-muted/30">
      <Helmet>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="w-full space-y-4">
            {FAQ_DATA.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="bg-card border border-border rounded-lg px-6 data-[state=open]:shadow-md transition-shadow">
        ...
        <div className="text-center mt-10">
          ...
          <a className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-medium hover:bg-primary/90 transition-colors" href="tel:3613597940">Call Us: +91 361 359 7940</a>
        </div>
      </div>
    </section>;
};
