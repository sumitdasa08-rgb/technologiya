...
const WhatsAppChannelBanner = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const triggerPoint = documentHeight - 600; // Show when 600px from bottom
  ...
  return (
    <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-50 animate-fade-up">
      <div className="relative bg-[#25D366] text-white px-4 py-3 rounded-2xl shadow-lg flex items-center gap-3">
        <button
